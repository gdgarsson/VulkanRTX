...
// Setter: set the object's size scalar
...
// Getter: returns the size scalar of the object
...
Matrix44f Object::getTranslationMatrix() {
...
Matrix44f Object::getScalarMatrix() {
	return Matrix44f(m_scale, 0.0f, 0.0f, 0.0f,
