...
protected:
	...
	float m_scale = 1.0f; // float of which the size of the object is scaled by
...
public:
	...
	float getScale();         // Returns the object's size scaler
	...
	Matrix44f getTranslationMatrix(); // Returns the object's position in 3D space as a 4x4 Matrix
	Matrix44f getScalarMatrix(); // Returns the object's Scalar matrix
